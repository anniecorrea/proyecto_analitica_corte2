...
El visualizador 1 corresponde a una reconstruccion inicial del volumen CT crudo. Se aplica un umbral HU para resaltar estructuras oseas y se muestra el resultado como vista 3D interactiva, complementada con proyecciones MIP.
